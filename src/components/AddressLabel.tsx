...
import { AddressLabelHistoryView } from './AddressLabelHistoryView';
...
export function AddressLabel({ isAdmin, prints, printsLoading, onRecordPrint }: Props) {
  ...
  async function handlePrint() {
    const error = await onRecordPrint(data);
  ...
  return (
    <div className="space-y-4">
      ...
      {view === 'history' ? (
        <AddressLabelHistoryView prints={prints} loading={printsLoading} onRecordPrint={onRecordPrint} />
      ) : (
        <>
